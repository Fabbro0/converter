...
android {
    namespace = "com.megaconverter.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.megaconverter.app"
        minSdk = 24
        targetSdk = 35
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // PDF read/write + text extraction
    implementation(libs.pdfbox.android)

    // Audio/video transcoding (community-maintained ffmpeg-kit fork,
